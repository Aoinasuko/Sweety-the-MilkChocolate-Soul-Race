...
{
    public abstract class WorkGiver_GatherSweetyBodyResources : WorkGiver_Scanner
    {
        ...
        public override IEnumerable<Thing> PotentialWorkThingsGlobal(Pawn pawn)
        {
            ...
            {
                if (pawn2.def.defName == "Sweety_Pawn")
                {
                    yield return pawn2;
                }
            }
    ...
    public abstract class JobDriver_GatherSweetyBodyResources : JobDriver
    {
    ...
    public class JobDriver_MilkSweety : JobDriver_GatherSweetyBodyResources
    {
    ...
    public class WorkGiver_MilkSweety : WorkGiver_GatherSweetyBodyResources
    {
        protected override JobDef JobDef
        {
            get
            {
                return Job_Sweety.MilkingSweety;
            }
        }
